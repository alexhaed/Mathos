...
if(count($_GET)) {
	...
	function erreurSelection() {
		echo '</script><br><br>Erreur dans la séléction<br><a href="addrelatifs.php">Retour</a>';
		exit();
	}
...
?>
		...
		<script>
			...
			async function saveResult() {
				const data = { userid: <?php echo $_SESSION['id']; ?>, exercice: "addrelatifs", nbcalculs: nbcalcul, reussis: nbcorrect, duree: duree };
			...
			function termine(arg) {
				...
				document.body.innerHTML += '<div style="text-align: center"><i class="fa-solid fa-arrow-rotate-right"></i> <a href="addrelatifs.php">Recommencer</a></div>';
				saveResult();
			}
...
?>
		<form id="formCalcul" method="GET" action="addrelatifs.php">
			<div class="content">
