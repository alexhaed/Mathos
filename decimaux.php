...
?>
		<script type="text/javascript">
			...
			function newValuesDiv() {
				val1 = generateRandomNumber(nbmax,decimal,0);
			  	val2 = generateRandomNumber(val1,decimal,0);
				return [val1,val2];
			 }
