...
?>
		...
		<script>
			...
			async function saveResult() {
				const data = { userid: <?php echo $_SESSION['id']; ?>, exercice: "prio", nbcalculs: nbcalcul, reussis: nbcorrect, duree: duree };
			...
			function termine(arg) {
				...
				document.body.innerHTML += '<div style="text-align: center"><i class="fa-solid fa-arrow-rotate-right"></i> <a href="prio.php">Recommencer</a></div>';
				saveResult();
			}
