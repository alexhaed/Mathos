...
if(count($_GET)) {
	...
	function erreurSelection() {
		echo '</script><br><br>Erreur dans la séléction<br><a href="prio.php">Retour</a>';
		exit();
	}
...
?>
		...
		<script>
			...
			function termine(arg) {
				if (arg == "temps") {
					feedback = 'Temps écoulé, dommage! &#128533<br><a href="prio.php">Recommencer</a>';
				}
				if (arg == "totalCalcul") {
					feedback = 'Fin des calculs, bravo! &#128526;<br><a href="prio.php">Recommencer</a>';
			...
			function checkReponse() {
				...
				if (reponse == correct) {
					...
					document.getElementById('stats').innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-circle-check"></i> Réussi: ' + nbcorrect + ' sur ' + nbcalcul;
